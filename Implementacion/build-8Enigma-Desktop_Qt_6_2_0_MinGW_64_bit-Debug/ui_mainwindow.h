...
"}"));
        ...
        pushButton->setGeometry(QRect(470, 80, 75, 24));
        titulo = new QLabel(centralwidget);
        titulo->setObjectName(QString::fromUtf8("titulo"));
        titulo->setGeometry(QRect(410, 10, 201, 61));
        QFont font;
        ...
        cronometro->setGeometry(QRect(660, 110, 91, 20));
        QFont font1;
        ...
        mesa->setGeometry(QRect(210, 140, 611, 351));
